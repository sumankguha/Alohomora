...
dataDir <- "~/Dropbox (Partners HealthCare)/Projects/R01_2017_OxycSA-NASh-Glutamate/_data_R01_2017/_data_R01_2017_ICSS/_ana_files/PM_ICSS/Cohort01/"
...
subjectList <- c("SG24", "SG20", 
                 "SG15",
                 "SG14",
                 "SG17")

# group information
group_lgaFemale <- c("SG24", "SG20")
group_lgaMale   <- c("SG15")
group_shaFemale <- c("SG14")
group_shaMale   <- c("SG17")

# output files 
outputFileName_allDates                 <- "_icssDataframe_allDates_cohort01.csv"
outputFileName_baseLineDates_longform   <- "_icssDataframe_baselineDates_longform_cohort01.csv"
outputFileName_baseLineDates_wideform   <- "_icssDataframe_baselineDates_wideform_cohort01.csv"
outputFileName_experimentDates_longform <- "_icssDataframe_experimentDates_longform_cohort01.csv"
outputFileName_experimentDates_wideform <- "_icssDataframe_experimentDates_wideform_cohort01.csv"
